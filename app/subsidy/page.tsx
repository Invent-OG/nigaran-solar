        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8">
              Learn how both Central and State Governments offer subsidies to
              make solar more accessible. We help you with the entire process.
            </p>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Explore various government subsidies available for solar
              installations
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Up to 40% subsidy on solar rooftop installations for residential customers",
                benefits: [
              ...
              },
              {
                ...
                description:
                  "Special incentives and tax benefits for businesses adopting solar energy",
                benefits: [
            ...
            {[
              {
                ...
                description:
                  "We assess your property and confirm subsidy eligibility",
              },
              {
                icon: <FileCheck className="h-8 w-8" />,
                title: "Documentation",
                description:
                  "Our team helps prepare and submit all required documents",
              },
              {
                icon: <HelpCircle className="h-8 w-8" />,
                title: "Support",
                description:
                  "We handle follow-ups and ensure successful processing",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            >
              ...
              <p className="text-primary-foreground/90 text-lg">
                Let our experts guide you through the subsidy application
                process.
              </p>
            </motion.div>
            <motion.div
