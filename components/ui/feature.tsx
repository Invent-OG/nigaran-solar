      ...
      <div className="container mx-auto">
        <div className="container grid items-center grid-cols-1 gap-8 p-8 border rounded-lg shadow-lg lg:grid-cols-2">
          ...
          <div className="rounded-md bg-muted aspect-square">
            <Image
              src={
                "https://images.unsplash.com/photo-1635424709870-cdc6e64f0e20?q=80&w=3542&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              }
              width={100}
              height={100}
