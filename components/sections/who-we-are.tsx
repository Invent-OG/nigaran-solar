    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container flex md:flex-row flex-col gap-10 justify-between md:p-[5%] p-[5%]">
        ...
        <div className="relative flex">
          ...
          <div className="absolute md:right-1/4 right-[55%] z-20 top-0">
            <MemoizedCircularProgress percent={85} label="Efficiency" />
          </div>
        ...
        <div className="lg:w-1/2 flex flex-col">
          ...
          >
            ...
            <motion.h2
              className="max-w-2xl text-3xl font-extrabold md:text-4xl"
              variants={{
                hidden: { opacity: 0, y: 20 },
                visible: { opacity: 1, y: 0 },
              }}
            ...
            <motion.div
              className="w-20 h-1 mb-6 bg-primary"
              variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}
            />

            <motion.p
              className="text-lg text-muted-foreground text-justify mb-6"
              variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}
            >
              Nigaran Solar is a prominent solar energy provider in Coimbatore
              and throughout Tamil Nadu. Having extensive experience in solar
...
// Memoized CircularProgress Component
const MemoizedCircularProgress = React.memo(function CircularProgress({
  percent,
  label,
}: {
  percent: number;
