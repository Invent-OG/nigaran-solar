...
//   return (
//     <section className=" lg:p-[5%] lg:pb-[10%] px-[2%] py-[10%] relative bg-white  ">
...
//             <div className="absolute lg:left-[-80px] lg:top-1/2 lg:-translate-y-1/2 lg:w-[400px] lg:h-[400px] h-[200px] w-[200px] rounded-full  bg-primary z-0"></div>
